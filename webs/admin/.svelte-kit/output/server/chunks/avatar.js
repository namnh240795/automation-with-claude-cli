import { a5 as sanitize_props, a3 as rest_props, G as fallback, l as attributes, q as clsx, D as ensure_array_like, A as element, ab as slot, m as bind_props, ad as spread_props } from "./renderer.js";
...
function Avatar($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div${attributes({
      class: clsx(cn("relative flex aspect-square items-center justify-center rounded-full bg-muted", className)),
      ...props
    })}>`);
    if (children) {
      $$renderer2.push("<!--[0-->");
      ...
      $$renderer2.push("<!--[-1-->");
      $$renderer2.push(`<span class="text-sm font-medium">?</span>`);
    }
    $$renderer2.push(`<!--]--></div>`);
  });
}
