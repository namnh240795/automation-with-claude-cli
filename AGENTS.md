...
This project is indexed by GitNexus as **automation-with-claude-cli** (6575 symbols, 12456 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
