...
This project is indexed by GitNexus as **automation-with-claude-cli** (8018 symbols, 16122 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
